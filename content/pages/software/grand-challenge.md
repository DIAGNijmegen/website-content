...
Organizers also provide an evaluation method in the form of a Docker container. This container automatically evaluates participant submissions on the test dataset, producing standardized performance metrics that are displayed on a live leaderboard.
...
The platform is built as a web application using Django, backed by a PostgreSQL database and a Celery task queue with Redis as message broker. It operates entirely on Amazon Web Services to ensure security, scalability, and availability.
